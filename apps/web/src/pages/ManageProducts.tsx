...
type ProductForm = Omit<Partial<Product>, "logo"> & { logo?: string };
    ...
    <section className="py-10 min-h-screen">
      <div className="container mx-auto">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-center">Produtos Nacionais</h2>
          ...
          <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
            <div className="bg-background p-6 rounded-xl shadow-card w-full max-w-lg border border-border max-h-[90vh] overflow-y-auto">
              <form onSubmit={handleSaveEdit} className="space-y-3">
                <h3 className="text-xl font-bold mb-2 text-center">Editar Produto</h3>
